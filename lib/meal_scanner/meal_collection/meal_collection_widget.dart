                        ...
                        child: Row(
                          ...
                          children: [
                            CircularPercentIndicator(
                              ...
                              center: Text(
                                '${functions.calculateTotalCalories(mealCollectionMealScannerRecordList.map((e) => e.calories).toList()).toString()}kcal',
                                style: FlutterFlowTheme.of(context)
                                    .headlineSmall
                                    .override(
                                      fontFamily: 'Poppins',
                              ...
                              child: StreamBuilder<List<MealScannerRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount: trainingfeedMealScannerRecordList
                                        .length,
                                                              ...
                                                              children: [
                                                                Theme(
                                                                  ...
                                                                  child:
                                                                      Checkbox(
                                                                    value: _model
                                                                            .checkboxValueMap[trainingfeedMealScannerRecord] ??=
                                                                        trainingfeedMealScannerRecord
                                                                            .isChecked,
                                                                    onChanged:
                                                                        (newValue) async {
                                                                      safeSetState(() =>
                                                                          _model.checkboxValueMap[trainingfeedMealScannerRecord] =
                                                                              newValue!);
                                                                      if (newValue!) {
