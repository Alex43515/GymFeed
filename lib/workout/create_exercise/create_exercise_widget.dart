                  ...
                  child: Row(
                    ...
                    children: [
                      FlutterFlowIconButton(
                        ...
                        hoverColor: const Color(0xFFBCB9B9),
                        icon: Icon(
                      ...
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: TextFormField(
                            controller: _model.exerciseNameSecondTextController,
                            focusNode: _model.exerciseNameSecondFocusNode,
                            autofocus: false,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                '6hc86d8d' /* Enter Exercise name */,
                              ),
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            safeSetState(() {
                              _model.exerciseNameSecondTextController?.clear();
