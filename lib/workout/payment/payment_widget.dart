...
w... */
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(45.0, 10.0, 0.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '3ucb136e' /* Up to 1000 conversations with ... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'r0ih60b5' /* Up to 100 uploads with Machine... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.isPurchaseSuccessful!) {
                                context.goNamed('assistantGPTPro');
                              } else {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      ...
                                      await showModalBottomSheet(
                                        ...
                                        builder: (context) {
                                          return Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child: const PrivacyPlocyWidget(),
                                          );
                                        },
                                      ).then((value) => safeSetState(() {}));
                                    },
