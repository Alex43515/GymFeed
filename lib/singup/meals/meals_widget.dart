        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(),
              signupPageDots(context: context, active: 1, count: 6),
                ...
                onPressed: () async {
                  if (_model.selected.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          'Please choose how many meals you eat per day.',
                  ...
                  FFAppState().meals = _model.selected;
                  FFAppState().update(() {});
                  context.pushNamed(FoodAlergiesWidget.routeName);
                },
              ),
            ],
          ),
