                                        ...
                                        image: DecorationImage(
                                          ...
                                          image: Image.network(
                                            functions.twicPicImagePath(
                                                ...
                                                '?alt=media&twic=v1/resize=200/cover=1:1'),
                                          ).image,
                                        ),
                                        shape: BoxShape.circle,
                                        border: Border.all(
                              ...
                              if (columnUsersRecord?.bio != null &&
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 4.0, 0.0, 0.0),
                                  child: Text(
                                    columnUsersRecord!.bio.maybeHandleOverflow(
                                      maxChars: 30,
                                    ),
                                    maxLines: 1,
                                    style: FlutterFlowTheme.of(context)
                        ...
                        child: TabBar(
                          ...
                          tabs: [
                            Tab(
                              ...
                              iconMargin: const EdgeInsets.all(1.0),
                            ),
                            Tab(
                              text: FFLocalizations.of(context).getText(
                                'suueoyxj' /* Tagged */,
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      decoration:
                                                                        ...
                                                                        image:
                                                                          ...
                                                                          image:
                                                                              Image.network(
                                                                            functions.twicPicImagePath(trainingfeedUserTrainingsRecord.trainingBackgroundImage,
                                                                                '?alt=media&twic=v1/resize=300/cover=1:1'),
                                                                          ).image,
                                                                        ),
                                                                        boxShadow: const [
